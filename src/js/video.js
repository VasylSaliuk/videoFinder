...
const key = `563492ad6f91700001000001157e38c8ce084c82ae5d994ba6f03525`;
...
form.addEventListener("submit", (evt) => {
  ...
  //передаем в запрос значение input через переменную query
  client.videos.search({ query, per_page }).then((result) => {
    // console.log(result);
    const videos = result.videos;
    console.log(videos);
    // const array = [];
    // const newVideos = videos.map((elem) => {
    //   elem.video_files = elem.videoFiles;
    //   return elem
    //   // console.log(elem);
    // });
